  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          mappings = {
            n = { ['<C-q>'] = require('telescope.actions').send_selected_to_qflist + require('telescope.actions').open_qflist },
          },
        },
        -- pickers = {}
        extensions = {
      ...
      vim.keymap.set('n', '<leader>st', builtin.treesitter, { desc = '[S]earch in [T]reesitter' })
